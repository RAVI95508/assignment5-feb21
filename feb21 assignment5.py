...
electrical={
    ...
    "non_electrical_equipments":["chair","bed","door"]
}
print(electrical["electrical_equipments"])
print(electrical["features"])
print(electrical["non_electrical_equipments"])
non_ele_equ=input("enter the non electrical equipment:")
if non_ele_equ in electrical["non_electrical_equipments"]:
    print(f"hey....! you enter {non_ele_equ}...right......!")
    ...
    print(f"sorry {non_ele_equ} is invalid....Pls type again thank you")
